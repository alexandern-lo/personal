...
namespace Avend.ApiTests.ControllerTests.DashboardController
{
    ...
    public class Dashboard_GetSuperadminAvgEventsHistoryMonthly_AccessControl: BaseDashboardEndpointTest
    {
        public const string DashboardUrl = "dashboard/superadmin/history/average_events/monthly";
