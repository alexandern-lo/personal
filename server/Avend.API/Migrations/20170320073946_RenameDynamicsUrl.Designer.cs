...
namespace Avend.API.Migrations
{
    ...
    [Migration("20170320073946_RenameDynamicsUrl")]
    partial class RenameDynamicsUrl
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Avend.API.Model.EventUserExpenseRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Avend.API.Model.EventUserGoalsRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Avend.API.Model.LeadRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("lead_id");
                    ...
                    b.HasIndex("SubscriptionId", "Qualification");
            ...
            modelBuilder.Entity("Avend.API.Model.AnswerChoiceRecord", b =>
                {
                    b.HasOne("Avend.API.Model.EventQuestionRecord", "Question")
                        .WithMany("Choices")
            ...
            modelBuilder.Entity("Avend.API.Model.AttendeeCategoryRecord", b =>
                {
                    b.HasOne("Avend.API.Model.EventRecord", "EventRecord")
            ...
            modelBuilder.Entity("Avend.API.Model.EventQuestionRecord", b =>
                {
                    ...
                    b.HasOne("Avend.API.Model.SubscriptionMember", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Avend.API.Model.LeadEmail", b =>
                {
                    b.HasOne("Avend.API.Model.LeadRecord", "LeadRecord")
                        .WithMany("Emails")
            ...
            modelBuilder.Entity("Avend.API.Model.LeadQuestionAnswer", b =>
                {
                    ...
                    b.HasOne("Avend.API.Model.EventQuestionRecord", "EventQuestion")
                        .WithMany()
                        .HasForeignKey("EventQuestionId");
            ...
            modelBuilder.Entity("Avend.API.Model.SettingsRecord", b =>
                {
                    b.HasOne("Avend.API.Model.CrmRecord", "DefaultCrm")
                        .WithOne("Settings")
                        .HasForeignKey("Avend.API.Model.SettingsRecord", "DefaultCrmId");
                });
