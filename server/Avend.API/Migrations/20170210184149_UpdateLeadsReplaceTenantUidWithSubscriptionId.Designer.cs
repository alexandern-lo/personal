...
namespace Avend.API.Migrations
{
    ...
    [Migration("20170210184149_UpdateLeadsReplaceTenantUidWithSubscriptionId")]
    partial class UpdateLeadsReplaceTenantUidWithSubscriptionId
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Avend.API.Model.Lead", b =>
                {
                    ...
                    b.HasIndex("UserUid", "UpdatedAt");

                    b.HasIndex("SubscriptionId", "Status", "Qualification");

                    b.HasIndex("UserUid", "Status", "CompanyName");

                    b.HasIndex("UserUid", "Status", "CreatedAt");

                    b.HasIndex("UserUid", "Status", "FirstName");

                    b.HasIndex("UserUid", "Status", "JobTitle");

                    b.HasIndex("UserUid", "Status", "LastName");

                    b.HasIndex("UserUid", "Status", "Qualification");
            ...
            modelBuilder.Entity("Avend.API.Model.Subscription", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("subscription_id");
            ...
            modelBuilder.Entity("Avend.API.Model.Lead", b =>
                {
                    ...
                    b.HasOne("Avend.API.Model.Subscription", "Subscription")
                        .WithMany()
