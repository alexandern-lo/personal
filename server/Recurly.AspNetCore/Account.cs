...
namespace Recurly.AspNetCore
{
    ...
    public class Account : RecurlyEntity
    {
        ...
        public BillingInfo BillingInfo
        {
            get
            {
                ...
                try
                {
                    _billingInfo = Task.Run(async () => await BillingInfo.Get(AccountCode)).Result;
                }
        ...
        /// <returns></returns>
        public async Task<RecurlyList<Adjustment>> GetAdjustments(Adjustment.AdjustmentType type = Adjustment.AdjustmentType.All,
        ...
        /// <returns></returns>
        public async Task<CouponRedemption> RedeemCoupon(string couponCode, string currency, string subscriptionUuid=null)
        {
            return await CouponRedemption.Redeem(AccountCode, couponCode, currency, subscriptionUuid);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<RecurlyList<CouponRedemption>> GetActiveRedemptions()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<CouponRedemption> GetActiveRedemption()
        {
            var activeRedemptions = await GetActiveRedemptions();
    ...
    public sealed class Accounts
    {
        ...
        /// <param name="accountCode"></param>
        /// <returns></returns>
        public static async Task<Account> Get(string accountCode)
        {
