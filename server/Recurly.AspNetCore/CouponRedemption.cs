...
namespace Recurly.AspNetCore
{
    ...
    public class CouponRedemption : RecurlyEntity
    {
        ...
        internal static async Task<CouponRedemption> Redeem(string accountCode, string couponCode, string currency, string subscriptionUuid=null)
        {
        ...
        {
            var statusCode = await Client.Instance.PerformRequest(Client.HttpRequestMethod.Delete,
