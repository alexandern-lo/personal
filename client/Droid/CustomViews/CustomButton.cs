...
namespace LiveOakApp.Droid.CustomViews
{
	...
	{
		public CustomButton(System.IntPtr javaReference, Android.Runtime.JniHandleOwnership transfer) : base(javaReference, transfer)
		{
		}
		...
		public CustomButton(Context context, IAttributeSet attrs) :
			base(context, attrs)
		{
		...
		public CustomButton(Context context, IAttributeSet attrs, int defStyle) :
