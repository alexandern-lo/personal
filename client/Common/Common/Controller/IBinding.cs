...
namespace StudioMobile
{
	...
	{
		/// <summary>
		/// Gets or sets a value indicating whether this <see cref="StudioMobile.IBinding"/> is enabled.
		/// </summary>
		...
		/// <summary>
		/// Gets a value indicating whether this <see cref="StudioMobile.IBinding"/> is bound.
		/// </summary>
		bool Bound { get; }
