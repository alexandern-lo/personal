...
namespace StudioMobile
{
	public class LayoutBox
	{
...
#if __IOS__
		public static LayoutBox FromCenterBounds (CoreGraphics.CGPoint center, CoreGraphics.CGRect bounds)
		{
			var rect = new RectangleF (
				           (float)(center.X - bounds.Width / 2), 
				           (float)(center.Y - bounds.Height / 2), 
				           (float)bounds.Width, 
				           (float)bounds.Height);
			return new LayoutBox (rect);
		}
#endif
		...
		#if __IOS__
		public static implicit operator CoreGraphics.CGRect (LayoutBox box)
		{
			return (CoreGraphics.CGRect)box.Bounds;
		}
		#endif
	}
}
