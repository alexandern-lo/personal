...
namespace StudioMobile
{
    public class GroupedObservableAdapter<GT, T> : BaseAdapter, IBinding where GT : IList<T>, INotifyCollectionChanged
    {
        ...
        /// </summary>
        public Func<int, GT, T, View, ViewGroup, View> ViewFactory
        {
            get;
            set;
        }
        ...
        /// view might be null, in which case a new View must be inflated by this method.
        /// </summary>
        public Func<int, GT, View, ViewGroup, View> HeaderViewFactory
        {
            get;
            set;
        }
    ...
    {
        /// <summary>
        /// Creates a new <see cref="GroupedObservableAdapter{GT, T}"/> for a given <see cref="ObservableCollection{ObservableCollection{T}}"/>.
        /// </summary>
        /// <typeparam name="GT">The type of the groups contained in the <see cref="ObservableCollection{ObservableCollection{T}}"/>.</typeparam>
        /// <typeparam name="T">The type of the items contained in the <see cref="ObservableCollection{ObservableCollection{T}}"/>.</typeparam>
