...
{
	public class CircleRemoteImageView : RemoteImageView
	{

		public CircleRemoteImageView(IntPtr javaReference, Android.Runtime.JniHandleOwnership transfer) : base(javaReference, transfer)
		{
			Initialize();
		}
		...
		public CircleRemoteImageView(Context context, IAttributeSet attrs) :
			base(context, attrs)
		{
			Initialize();
		}

		public CircleRemoteImageView(Context context, IAttributeSet attrs, int defStyle) :
